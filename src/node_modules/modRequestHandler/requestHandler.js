...
function serveResource(context) {
   ...
   * @param useCache {Boolean} Use the cached version of the file
   * @param fd       {Object} File data
   * @param stats    {Object} File information
   * @param mimeType {String} MIME type of the file
   */
  function sendResource(useCache, fd, stats, mimeType) {
  ...
  fileFetcher.fetchResource(resource, client, modSince).then( sendResource,
      ...
      function(message, fetchCode) {
        ...
        if (code !== 404 && code !== 500) {
          ...
          if (fetchCode === 404) {
            // Fetch the 404.html
            fileFetcher.fetchResource('404.html', client, null).then( sendResource, sendErrorJSON);

          } else if (fetchCode === 500) {
            // Fetch the 500.html
            fileFetcher.fetchResource('500.html', client, null).then( sendResource, sendErrorJSON);
