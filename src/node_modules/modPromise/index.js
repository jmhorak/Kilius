 ...
 * @param failCallback {function} - Callback used when the async operation has an error
 */
exports.Promise.prototype.then = function(resolveCallback, failCallback) {
 ...
 */
exports.Promise.prototype.resolve = function() {
  // Move to resolved state
  this.state = 'resolved';

  if (typeof this.resolveCallback === 'function') {
    this.resolveCallback.apply(null, arguments);
  }
 ...
 */
exports.Promise.prototype.reject = function() {
 ...
 *
 * @return {exports.Promise} - Returns a promise which is used to synchronize between the supplied promises
 */
exports.Promise.when = function() {
  var args = Array.prototype.slice.call(arguments, 0),
      promises = [],
      promise = new exports.Promise(),
      resolveArgs = null;

  // Replace the 'then' function with a new one
  promise.then = function(resolve, fail) {
    ...
    args.forEach(function(item) {
      ...
      if (item instanceof exports.Promise) {
        ...
        item.resolve = function() {
          ...
          var idx = promises.indexOf(this),
              instanceArgs = Array.prototype.slice.call(arguments, 0);
          ...
          exports.Promise.prototype.resolve.apply(this, arguments);
        };
